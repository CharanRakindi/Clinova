...
const StatCard = ({ title, value, icon: Icon, description, className, index = 0 }) => {
  return (
    <motion.div
      ...
      className={cn(
        "glass-card p-6 flex flex-col justify-between relative overflow-hidden group border-slate-100/50", 
        className
      )}
    >
      ...
      <div className="flex items-center justify-between relative z-10">
        ...
        {Icon && (
          <div className="p-2.5 rounded-xl bg-slate-50 text-slate-400 group-hover:text-primary-500 group-hover:bg-primary-50 transition-all duration-300 border border-slate-100/50">
