...
import { Plus, X, Calendar, Clock, Stethoscope, FileText, CheckCircle } from 'lucide-react';
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      {['requested', 'confirmed'].includes(apt.status) && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-lg transition-all border border-rose-200 text-rose-700 bg-rose-50 hover:bg-rose-100 hover:border-rose-300 shadow-sm disabled:opacity-50"
                        >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5 bg-slate-50/50">
              <div className="space-y-4">
                <div>
                  ...
                  <select 
                    className="w-full pl-3 pr-8 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-medium focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all outline-none appearance-none"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      type="date" 
                      className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-medium focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all outline-none"
                ...
                <div>
                  ...
                  <textarea 
                    className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-medium focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all outline-none resize-none"
                    rows="3"
